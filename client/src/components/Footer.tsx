        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <div className="flex items-center">
              ...
              <span className="text-lg font-semibold text-neutral-800">TokenBurn</span>
            </div>
            <p className="text-sm text-neutral-500 mt-1">Bridging digital tokens to physical goods</p>
          </div>
        ...
        <div className="border-t border-neutral-200 mt-6 pt-6">
          <div className="flex flex-col md:flex-row justify-between">
            ...
            <div className="text-sm text-neutral-500">
              &copy; {new Date().getFullYear()} TokenBurn. Built on Hedera. All rights reserved.
            </div>
          </div>
        </div>
      </div>
